...
4. **Hikma Foundation training infrastructure**
...
- [Network Scanning with NMAP](./NMAP_Lesson_Plan.md)
- [Web Security Testing with Burp Suite](./BurpSuite_Lesson_Plan.md)
- [Password Security with Hashcat](./Hashcat_Lesson_Plan.md)
...
- [x] I have signed the Hikma Foundation **Do No Harm Agreement**
- [x] I will only use these materials for **authorized, lawful purposes**
- [x] I understand unauthorized access is a **serious crime**
- [x] I accept **full personal responsibility** for my actions
- [x] I agree to **indemnify Hikma Foundation** for any misuse
- [x] I understand violations result in **immediate termination and legal action**
