...
VMWare creates the **SPACE** within your laptop to start learning to hack!
...
- **Install VMWare:** [https://drive.google.com/file/d/1cOH6UfjsiK0u0COzKkJDs7lu6-Uuk6h-/view?usp=sharing]
...
If you are finished editing and want to save and close nano immediately: 
1. Press Ctrl + X.
2. If you have unsaved changes, nano will ask: Save modified buffer?.
Press Y for "Yes".
3. Press Enter to confirm the filename and exit to the terminal. 
